...
class VectorTestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.vectorView.animateFadeIn = true                 //Se deve animar a opacidade do SVG junto com o desenho
        self.vectorView.onlyFillAfterAnimation = true        //Se verdadeiro, a cor de preenchimento só aparecerá depois da animação
        self.vectorView.onlyStrokeAfterAnimation = true      //Se verdadeiro, a cor de desenho só aparecerá depois da animação
